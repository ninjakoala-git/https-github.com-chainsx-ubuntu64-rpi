...
| 版本 | 下载链接 |
|--------|--------|
| ubuntu-16.04-aarch64-stable-with-wifi(稳定版带wifi，使用方法在上面。) | [链接](https://pan.baidu.com/s/1htHqn7Q) |
| ubuntu-16.04-aarch64-alpha-4.16-kernel(Alpha测试版) | [链接](https://github.com/chainsx/ubuntu64-rpi/blob/ubuntu-16.04.3-arm64/Documentation/about-test.md) |
| ubuntu-16.04-aarch64-beta-4.14-3b-3b+(beta测试版，支持3b+)  | [链接](https://pan.baidu.com/s/1l1AeHBrFj3BVSQPM4Ikj3A)
